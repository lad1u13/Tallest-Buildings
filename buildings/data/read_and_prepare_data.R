...
countries <-
  read.csv('countries of the world.csv', # name of csv file to read
...
buildings <-
  read.csv('tallest_completed_buildings.csv') %>%
...
cities <-
  read.csv('The Most Largest Cities in the World 1950 - 2035.csv',
           check.names = FALSE) %>%
